  ...
  return (
    <div style={{ fontFamily: "'SF Pro Display', -apple-system, BlinkMacSystemFont, sans-serif" }}
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-blue-100 opacity-40 blur-3xl" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-purple-100 opacity-30 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-semibold text-gray-900 tracking-tight">Sign in</h1>
          <p className="text-gray-500 mt-1 text-sm">to continue to TaskAI</p>
        </div>
